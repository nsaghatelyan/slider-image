...
?>
<div>
    <span class="buy-pro"><?php _e('This feature is disabled in free version', 'hugeit-slider'); ?>
        . <br><?php _e('If you need this functionality, you need to', 'hugeit-slider'); ?> <a
                href="https://huge-it.com/slider/"
                target="_blank"><?php _e('buy the commercial version', 'hugeit-slider'); ?></a>.</span>
</div>
<div id="hugeit_slider_add_post_popup_tabs">
    ...
    <div id="static_posts" class="hugeit-slider-tab">
        ...
        <table id="hugeit_slider_post_slide_popup_table">
            ...
            <?php foreach ($posts as $post) :
                ...
                <tr class="hugeit-slider-post-popup-table-row hugeit-slider-not-selected-post-slide">
                    <td class="post-id invisible"><input type="checkbox" name="id" value="<?php echo $post->ID; ?>"/>
                    </td>
        ...
        <button type="button" class="button button-primary"
                id="hugeit_slider_add_static_post_slide"><?php _e('Add Slide', 'hugeit-slider'); ?></button>
    </div>
    <div id="last_posts" class="hugeit-slider-tab">
        <form>
            ...
            <label><?php _e('Showing Posts Count', 'hugeit-slider'); ?>:
                <input type="number" min="1" id="hugeit_slider_dynamic_post_max_post_count" name="max_post_count"
                       value="3"/>
            </label>
            <br/>
            ...
            <button type="button" class="button button-primary"
                    id="hugeit_slider_add_dynamic_post_slide"><?php _e('Add Slide', 'hugeit-slider'); ?></button>
        </form>
    </div>
</div>